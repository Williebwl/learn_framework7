...
if (typeof jQuery === "undefined") {
    ...
    var b = function (f, e) {
        ...
        if (this.options.remote && !/^\s?javascript:*/.test(this.options.remote)) {
    ...
    b.prototype.show = function (h) {
        ...
        this.backdrop(function () {
            ...
            f.enforceFocus();
            f.$element.children().eq(0).css("position", "absolute").css({
                "margin": "0px",
                "top": function () {
                    return (f.$element.height() - f.$element.children().eq(0).height() - 40) / 2 + "px"
                },
                "left": function () {
                    return (f.$element.width() - f.$element.children().eq(0).width()) / 2 + "px"
                }
            });
